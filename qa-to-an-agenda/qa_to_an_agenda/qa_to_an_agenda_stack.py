...
class QaToAnAgendaStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        s3_deploy = S3Deploy(self, "qa-to-an-agenda", "agenda_reinvent_2023","agenda_reinvent_2023")
